...
| ---------------------------------------------------------------------------------- | ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The existing web and API builds pass from a clean checkout                         | **Met**                        | The strictly stronger [M9 local release proof](status/evidence/M9-local-release-proof.md) records the pinned clean-checkout format, lint, typecheck, 828-assertion test (829 with the post-fix regression assertion), production-build, browser, policy, container, and restore matrix on Node 24.13 / pnpm 11.9                                                  |
